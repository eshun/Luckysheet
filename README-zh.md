...
## 介绍
🚀sheet ，一款纯前端类似excel的在线表格，功能强大、配置简单、完全开源。
...
## 相关链接
 ...
 | ------ | -------- | ------ | ------ | ------ |
 | [Github](https://github.com/mengshukeji/sheet)| [在线文档](https://mengshukeji.github.io/sheetDocs/zh/) | [在线Demo](https://mengshukeji.github.io/sheetDemo) / [协同编辑Demo](http://sheet.lashuju.com/demo/) | [导入Excel Demo](https://mengshukeji.github.io/LuckyexcelDemo/) | [中文论坛](https://support.qq.com/product/288322) |
 | [Gitee镜像](https://gitee.com/mengshukeji/sheet)| [Gitee在线文档](https://mengshukeji.gitee.io/sheetDocs/zh/) | [Gitee在线Demo](https://mengshukeji.gitee.io/sheetdemo/) | [Gitee导入Excel Demo](https://mengshukeji.gitee.io/luckyexceldemo/) | [Google Group](https://groups.google.com/g/sheet) |

![演示](/docs/.vuepress/public/img/sheetDemo.gif)
...
| 工程 | 描述 |
|---------|-------------|
| [sheet Vue]          | 在vue cli 3项目中使用sheet和Luckyexcel|
| [sheet React]          | 在React项目中使用sheet |
| [Luckyexcel Node]          | 在koa2中使用Luckyexcel |
| [sheet Server]          | Java后台sheet Server |
| [sheet Server Starter]          | sheetServer 一键docker部署 |

[sheet Vue]: https://gitee.com/mengshukeji/sheet-vue
[sheet React]: https://gitee.com/mengshukeji/sheet-react
[Luckyexcel Node]: https://gitee.com/mengshukeji/Luckyexcel-node
[sheet Server]: https://gitee.com/mengshukeji/sheetServer
[sheet Server Starter]: https://gitee.com/mengshukeji/sheetServerStarter
...
更详细的功能列表，请查阅：[特性](https://mengshukeji.github.io/sheetDocs/zh/guide/#%E7%89%B9%E6%80%A7)

## 📖 学习资源

- 新用户优先阅读：[用户指引](https://github.com/mengshukeji/sheet/wiki/User-Guide)
- 社区提供的教程、学习资料及配套解决方案请查阅：[教程与资源](https://mengshukeji.github.io/sheetDocs/zh/guide/resource.html)
...
在反馈问题之前，请确保仔细阅读 [如何提交问题](https://mengshukeji.github.io/sheetDocs/zh/guide/contribute.html#如何提交问题)。 不符合准则的问题可能会立即被移除。

## ✅ 开发计划

通过 [GitHub Projects](https://github.com/mengshukeji/sheet/projects/1) 管理

## 💪 贡献

在提交PR之前，请确保仔细阅读 [贡献指南](https://mengshukeji.github.io/sheetDocs/zh/guide/contribute.html)。
...
- [Github 论坛](https://github.com/mengshukeji/sheet/discussions)
- 以下扫码加入官方微信群或者QQ群

| 官方微信群 |  群满则加小编微信，备注:加群  | QQ群 |
|---|---|---|
| <img src="https://minio.cnbabylon.com/public/sheet/sheet_wechat_group.png" width="200" /> | <img src="https://minio.cnbabylon.com/public/sheet/dushusir_wechat.jpg" width="200" />| <img src="https://minio.cnbabylon.com/public/sheet/sheet_qq_group.jpg" width="200" /> |
...
sheet是MIT许可的开源项目，其持续稳定的开发离不开这些优秀的 [**支持者**](https://mengshukeji.github.io/sheetDocs/zh/about/sponsor.html#%E8%B5%9E%E5%8A%A9%E8%80%85%E5%88%97%E8%A1%A8)。 如果您想加入他们，请考虑：
